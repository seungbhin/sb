#!/bin/bash
# Head-Wise LoRA 학습 스크립트
# train_lora.sh와 동일한 데이터/환경 설정 사용

# 스크립트 위치 기준으로 sb/ 루트로 이동 (어디서 실행하든 동일하게 동작)
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
cd "$SCRIPT_DIR/.."  # train/ → sb/
...
export MOTION_PATH='/home/sbjeon/workspace2/sb/train/test_data/motion/skateboarding'

BASE_OUTPUT_PATH='/home/sbjeon/workspace2/sb/train/output/train_lora/head_wise_dog_skateboarding'
...
/home/sbjeon/.conda/envs/bhin/bin/accelerate launch --config_file train/config/finetune_adapter_single.yaml \
